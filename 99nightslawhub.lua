...
local Window = Library:Window({
    Title = "Laws Hub",
    Desc = "Laws Hub for 99 Nights in the Forest",
...
local Main = Window:Tab({Title = "Main", Icon = "eye"}) 
Main:Section({Title = "Auto Feed"})
Main:Dropdown({
    Title = "Select Food",
...
local Auto = Window:Tab({Title = "Auto", Icon = "wrench"}) 
Auto:Section({Title = "Auto Upgrade Campfire"})
local autoUpgradeCampfireEnabled = false
Auto:Dropdown({
    Title = "Auto Upgrade Campfire",
    Desc = "Choose the items",
    List = campfireFuelItems,
    Multi = true,
...
Auto:Toggle({
    Title = "Auto Upgrade Campfire",
    Desc = "Toggle auto upgrade campfire",
    Value = false,
...
Auto:Section({Title = "Auto Cook Food"})
Auto:Dropdown({
    Title = "Auto Cook Food",
    Desc = "Choose items to cook",
    List = autocookItems,
    Multi = true,
    Callback = function(options)
...
local Esp = Window:Tab({Title = "Esp", Icon = "sparkles"}) 
...
Esp:Section({Title = "Esp Items"})
Esp:Dropdown({
    Title = "Esp Items",
    Desc = "Select items for ESP",
    List = ie,
    Multi = true,
    Callback = function(options)
...
Esp:Section({Title = "Esp Entity"})
Esp:Dropdown({
    Title = "Esp Entity",
    Desc = "Select entities for ESP",
    List = me,
    Multi = true,
    Callback = function(options)
...
local Br = Window:Tab({Title = "Bring", Icon = "package"}) 
Br:Section({Title = "Junk"})
Br:Dropdown({
...
Br:Button({
    ...
    Desc = "Bring selected junk items",
    Callback = function()
...
Br:Button({
    ...
    Desc = "Bring selected equipment items",
    Callback = function()
        local player = game.Players.LocalPlayer
        if not player.Character or not player.Character:FindFirstChild("HumanoidRootPart") then return end
        local hrp = player.Character.HumanoidRootPart
...
Tp:Button({
    ...
    Desc = "Teleport to stronghold",
    Callback = function()
        tp2()
    end
})
Tp:Section({Title = "Children"})
local MobDropdown = Tp:Dropdown({
    Title = "Select Child",
    Desc = "Choose child to teleport to",
    List = currentMobNames,
    Multi = false,
    Callback = function(options)
...
Tp:Button({
    ...
    Desc = "Teleport to selected child",
    Callback = function()
...
Tp:Section({Title = "Chest"})
local ChestDropdown = Tp:Dropdown({
    Title = "Select Chest",
    Desc = "Choose chest to teleport to",
    List = currentChestNames,
    Multi = false,
    Callback = function(options)
...
Tp:Button({
    ...
    Desc = "Teleport to selected chest",
    Callback = function()
...
local Fly = Window:Tab({Title = "Player", Icon = "user"}) 
Fly:Section({Title = "Main"})
Fly:Slider({
    Title = "Fly Speed",
    Min = 1,
    Max = 20,
...
Window:Notify({
    Title = "Laws Hub",
    Desc = "Laws Hub loaded successfully!",
    Time = 4
})